 ...
 * @generated
 */
public class As_foaaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case As_foaaPackage.FIELD_OF_ACTIVITY_ANNOTATION_REPOSITORY: {
			...
			case As_foaaPackage.CALIBRATION_CONFIGURATION: {
			...
			case As_foaaPackage.DOCUMENTATION: {
			...
			case As_foaaPackage.COMPONENT_DRAWING: {
			...
			case As_foaaPackage.MODULE_DRAWING: {
			...
			case As_foaaPackage.INTERFACE_DRAWING: {
			...
			case As_foaaPackage.STRUCTURE_DRAWING: {
			...
			case As_foaaPackage.MAINTENEANCE_DOCUMENTATION: {
			...
			case As_foaaPackage.OPERATOR_INSTRUCTIONS: {
			...
			case As_foaaPackage.TRAINING_DOC_INTERN: {
			...
			case As_foaaPackage.TRAINING_DOC_EXTERNAL: {
			...
			case As_foaaPackage.MODULE_DOCUMENTATION_FILES: {
			...
			case As_foaaPackage.INTERFACE_DOCUMENTATION_FILES: {
			...
			case As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES: {
			...
			case As_foaaPackage.STOCK_LIST: {
			...
			case As_foaaPackage.COMPONENT_STOCK_LIST: {
			...
			case As_foaaPackage.INTERFACE_STOCK_LIST: {
			...
			case As_foaaPackage.MODULE_STOCK_LIST: {
			...
			case As_foaaPackage.STRUCTURE_STOCK_LIST: {
