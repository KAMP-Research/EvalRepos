 ...
 * @generated
 */
public class PpustructuresSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PpustructuresPackage.CONVEYOR: {
			...
			case PpustructuresPackage.PNEUMATIC_NETWORK: {
			...
			case PpustructuresPackage.COMMUNICATION_NETWORK: {
			...
			case PpustructuresPackage.POWER_NETWORK: {
			...
			case PpustructuresPackage.CRANE: {
			...
			case PpustructuresPackage.POWER_WIRING: {
			...
			case PpustructuresPackage.LOGICAL_WIRING: {
