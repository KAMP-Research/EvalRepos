 ...
 * </p>
 * <ul>
 *   <li>{@link domain.ppu.ppumodules.impl.PresenceSensorModuleImpl#getPresenceSensor <em>Presence Sensor</em>}</li>
 *   <li>{@link domain.ppu.ppumodules.impl.PresenceSensorModuleImpl#getBusSlave <em>Bus Slave</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PresenceSensorModuleImpl extends ModuleImpl implements PresenceSensorModule {
	...
	protected EClass eStaticClass() {
		return PpumodulesPackage.Literals.PRESENCE_SENSOR_MODULE;
	}
	...
	public EList<PresenceSensor> getPresenceSensor() {
		if (presenceSensor == null) {
			presenceSensor = new EObjectContainmentEList<PresenceSensor>(PresenceSensor.class, this, PpumodulesPackage.PRESENCE_SENSOR_MODULE__PRESENCE_SENSOR);
		}
	...
	public EList<BusSlave> getBusSlave() {
		if (busSlave == null) {
			busSlave = new EObjectContainmentEList<BusSlave>(BusSlave.class, this, PpumodulesPackage.PRESENCE_SENSOR_MODULE__BUS_SLAVE);
		}
		return busSlave;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PpumodulesPackage.PRESENCE_SENSOR_MODULE__PRESENCE_SENSOR:
				return ((InternalEList<?>)getPresenceSensor()).basicRemove(otherEnd, msgs);
			case PpumodulesPackage.PRESENCE_SENSOR_MODULE__BUS_SLAVE:
