 ...
 * </p>
 * <ul>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getRack_for_turningtable <em>Rack for turningtable</em>}</li>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getTable_to_stand_on <em>Table to stand on</em>}</li>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getMotor_to_drive <em>Motor to drive</em>}</li>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getBusSlave <em>Bus Slave</em>}</li>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getBusBox <em>Bus Box</em>}</li>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getBusCable <em>Bus Cable</em>}</li>
 *   <li>{@link domain.aps.components.impl.TurningTableImpl#getPotentiometer <em>Potentiometer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurningTableImpl extends ModuleImpl implements TurningTable {
	...
	protected EClass eStaticClass() {
		return ComponentsPackage.Literals.TURNING_TABLE;
	}
	...
	public NotificationChain basicSetRack_for_turningtable(Rack newRack_for_turningtable, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__RACK_FOR_TURNINGTABLE, oldRack_for_turningtable, newRack_for_turningtable);
	...
	public void setRack_for_turningtable(Rack newRack_for_turningtable) {
		if (newRack_for_turningtable != rack_for_turningtable) {
			...
			if (rack_for_turningtable != null)
				msgs = ((InternalEObject)rack_for_turningtable).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__RACK_FOR_TURNINGTABLE, null, msgs);
			if (newRack_for_turningtable != null)
				msgs = ((InternalEObject)newRack_for_turningtable).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__RACK_FOR_TURNINGTABLE, null, msgs);
			msgs = basicSetRack_for_turningtable(newRack_for_turningtable, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__RACK_FOR_TURNINGTABLE, newRack_for_turningtable, newRack_for_turningtable));
	}
	...
	public NotificationChain basicSetTable_to_stand_on(Table newTable_to_stand_on, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__TABLE_TO_STAND_ON, oldTable_to_stand_on, newTable_to_stand_on);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTable_to_stand_on(Table newTable_to_stand_on) {
		if (newTable_to_stand_on != table_to_stand_on) {
			...
			if (table_to_stand_on != null)
				msgs = ((InternalEObject)table_to_stand_on).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__TABLE_TO_STAND_ON, null, msgs);
			if (newTable_to_stand_on != null)
				msgs = ((InternalEObject)newTable_to_stand_on).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__TABLE_TO_STAND_ON, null, msgs);
			msgs = basicSetTable_to_stand_on(newTable_to_stand_on, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__TABLE_TO_STAND_ON, newTable_to_stand_on, newTable_to_stand_on));
	}
	...
	public NotificationChain basicSetMotor_to_drive(SimpleMotor newMotor_to_drive, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__MOTOR_TO_DRIVE, oldMotor_to_drive, newMotor_to_drive);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMotor_to_drive(SimpleMotor newMotor_to_drive) {
		if (newMotor_to_drive != motor_to_drive) {
			...
			if (motor_to_drive != null)
				msgs = ((InternalEObject)motor_to_drive).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__MOTOR_TO_DRIVE, null, msgs);
			if (newMotor_to_drive != null)
				msgs = ((InternalEObject)newMotor_to_drive).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__MOTOR_TO_DRIVE, null, msgs);
			msgs = basicSetMotor_to_drive(newMotor_to_drive, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__MOTOR_TO_DRIVE, newMotor_to_drive, newMotor_to_drive));
	}
	...
	public NotificationChain basicSetBusSlave(BusSlave newBusSlave, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__BUS_SLAVE, oldBusSlave, newBusSlave);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBusSlave(BusSlave newBusSlave) {
		if (newBusSlave != busSlave) {
			NotificationChain msgs = null;
			if (busSlave != null)
				msgs = ((InternalEObject)busSlave).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__BUS_SLAVE, null, msgs);
			if (newBusSlave != null)
				msgs = ((InternalEObject)newBusSlave).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__BUS_SLAVE, null, msgs);
			msgs = basicSetBusSlave(newBusSlave, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__BUS_SLAVE, newBusSlave, newBusSlave));
	}
	...
	public NotificationChain basicSetBusBox(BusBox newBusBox, NotificationChain msgs) {
		...
		busBox = newBusBox;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__BUS_BOX, oldBusBox, newBusBox);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBusBox(BusBox newBusBox) {
		if (newBusBox != busBox) {
			NotificationChain msgs = null;
			if (busBox != null)
				msgs = ((InternalEObject)busBox).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__BUS_BOX, null, msgs);
			if (newBusBox != null)
				msgs = ((InternalEObject)newBusBox).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ComponentsPackage.TURNING_TABLE__BUS_BOX, null, msgs);
			msgs = basicSetBusBox(newBusBox, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.TURNING_TABLE__BUS_BOX, newBusBox, newBusBox));
	}
	...
	public EList<BusCable> getBusCable() {
		if (busCable == null) {
			busCable = new EObjectContainmentEList<BusCable>(BusCable.class, this, ComponentsPackage.TURNING_TABLE__BUS_CABLE);
		}
		return busCable;
	}
	...
	public EList<Potentiometer> getPotentiometer() {
		if (potentiometer == null) {
			potentiometer = new EObjectContainmentEList<Potentiometer>(Potentiometer.class, this, ComponentsPackage.TURNING_TABLE__POTENTIOMETER);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ComponentsPackage.TURNING_TABLE__RACK_FOR_TURNINGTABLE:
				return basicSetRack_for_turningtable(null, msgs);
			case ComponentsPackage.TURNING_TABLE__TABLE_TO_STAND_ON:
				return basicSetTable_to_stand_on(null, msgs);
			case ComponentsPackage.TURNING_TABLE__MOTOR_TO_DRIVE:
				return basicSetMotor_to_drive(null, msgs);
			case ComponentsPackage.TURNING_TABLE__BUS_SLAVE:
				return basicSetBusSlave(null, msgs);
			case ComponentsPackage.TURNING_TABLE__BUS_BOX:
				return basicSetBusBox(null, msgs);
			case ComponentsPackage.TURNING_TABLE__BUS_CABLE:
				return ((InternalEList<?>)getBusCable()).basicRemove(otherEnd, msgs);
			case ComponentsPackage.TURNING_TABLE__POTENTIOMETER:
