 ...
 * </p>
 * <ul>
 *   <li>{@link domain.aps.components.impl.RackImpl#getScrewing_to_base <em>Screwing to base</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RackImpl extends ComponentImpl implements Rack {
	...
	protected EClass eStaticClass() {
		return ComponentsPackage.Literals.RACK;
	}
		...
		if (screwing_to_base != null && screwing_to_base.eIsProxy()) {
			...
			if (screwing_to_base != oldScrewing_to_base) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ComponentsPackage.RACK__SCREWING_TO_BASE, oldScrewing_to_base, screwing_to_base));
			}
		}
	...
	public void setScrewing_to_base(Screwing newScrewing_to_base) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ComponentsPackage.RACK__SCREWING_TO_BASE, oldScrewing_to_base, screwing_to_base));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ComponentsPackage.RACK__SCREWING_TO_BASE:
