 ...
 * </p>
 * <ul>
 *   <li>{@link domain.as.ModuleRepository.impl.ModuleImpl#getParentEntity <em>Parent Entity</em>}</li>
 *   <li>{@link domain.as.ModuleRepository.impl.ModuleImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link domain.as.ModuleRepository.impl.ModuleImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link domain.as.ModuleRepository.impl.ModuleImpl#getInterfaces <em>Interfaces</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModuleImpl extends EntityImpl implements domain.as.ModuleRepository.Module {
	/**
	...
	public EList<domain.as.ModuleRepository.Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<domain.as.ModuleRepository.Module>(domain.as.ModuleRepository.Module.class, this, ModuleRepositoryPackage.MODULE__MODULES);
		}
		return modules;
	}
