 ...
 * </p>
 * <ul>
 *   <li>{@link domain.as.ComponentRepository.impl.ComponentImpl#getConnectedInterfaces <em>Connected Interfaces</em>}</li>
 *   <li>{@link domain.as.ComponentRepository.impl.ComponentImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link domain.as.ComponentRepository.impl.ComponentImpl#getParentModule <em>Parent Module</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends EntityImpl implements Component {
	 ...
	 * @generated
	 */
	public domain.as.ModuleRepository.Module getParentModule() {
		if (eContainerFeatureID() != ComponentRepositoryPackage.COMPONENT__PARENT_MODULE) return null;
		return (domain.as.ModuleRepository.Module)eInternalContainer();
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetParentModule(domain.as.ModuleRepository.Module newParentModule, NotificationChain msgs) {
	 ...
	 * @generated
	 */
	public void setParentModule(domain.as.ModuleRepository.Module newParentModule) {
		if (newParentModule != eInternalContainer() || (eContainerFeatureID() != ComponentRepositoryPackage.COMPONENT__PARENT_MODULE && newParentModule != null)) {
			...
			if (newParentModule != null)
				msgs = ((InternalEObject)newParentModule).eInverseAdd(this, ModuleRepositoryPackage.MODULE__COMPONENTS, domain.as.ModuleRepository.Module.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case ComponentRepositoryPackage.COMPONENT__PARENT_MODULE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetParentModule((domain.as.ModuleRepository.Module)otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			...
			case ComponentRepositoryPackage.COMPONENT__PARENT_MODULE:
				return eInternalContainer().eInverseRemove(this, ModuleRepositoryPackage.MODULE__COMPONENTS, domain.as.ModuleRepository.Module.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case ComponentRepositoryPackage.COMPONENT__PARENT:
				...
				return;
			case ComponentRepositoryPackage.COMPONENT__PARENT_MODULE:
				setParentModule((domain.as.ModuleRepository.Module)newValue);
				return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case ComponentRepositoryPackage.COMPONENT__PARENT:
				...
				return;
			case ComponentRepositoryPackage.COMPONENT__PARENT_MODULE:
				setParentModule((domain.as.ModuleRepository.Module)null);
				return;
		}
