...
import quality.as_mm.impl.ModifyComponentImpl;
 ...
 * </p>
 * <ul>
 *   <li>{@link quality.aps_mm.impl.ModifySensorImpl#getModifySignalInterfaces <em>Modify Signal Interfaces</em>}</li>
 *   <li>{@link quality.aps_mm.impl.ModifySensorImpl#getModifyPhysicalConnections <em>Modify Physical Connections</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModifySensorImpl extends ModifyComponentImpl<Sensor> implements ModifySensor {
	...
	protected EClass eStaticClass() {
		return Aps_mmPackage.Literals.MODIFY_SENSOR;
	}
	...
	public EList<SignalInterface> getModifySignalInterfaces() {
		if (modifySignalInterfaces == null) {
			modifySignalInterfaces = new EObjectContainmentEList<SignalInterface>(SignalInterface.class, this, Aps_mmPackage.MODIFY_SENSOR__MODIFY_SIGNAL_INTERFACES);
		}
	...
	public EList<PhysicalConnection> getModifyPhysicalConnections() {
		if (modifyPhysicalConnections == null) {
			modifyPhysicalConnections = new EObjectContainmentEList<PhysicalConnection>(PhysicalConnection.class, this, Aps_mmPackage.MODIFY_SENSOR__MODIFY_PHYSICAL_CONNECTIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Aps_mmPackage.MODIFY_SENSOR__MODIFY_SIGNAL_INTERFACES:
				return ((InternalEList<?>)getModifySignalInterfaces()).basicRemove(otherEnd, msgs);
			case Aps_mmPackage.MODIFY_SENSOR__MODIFY_PHYSICAL_CONNECTIONS:
