 ...
 * </p>
 * <ul>
 *   <li>{@link domain.as.StructureRepository.impl.StructureImpl#getParentPlant <em>Parent Plant</em>}</li>
 *   <li>{@link domain.as.StructureRepository.impl.StructureImpl#getModules <em>Modules</em>}</li>
 *   <li>{@link domain.as.StructureRepository.impl.StructureImpl#getComponents <em>Components</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureImpl extends EntityImpl implements Structure {
	...
	public void setParentPlant(Plant newParentPlant) {
		if (newParentPlant != eInternalContainer() || (eContainerFeatureID() != StructureRepositoryPackage.STRUCTURE__PARENT_PLANT && newParentPlant != null)) {
			...
			if (newParentPlant != null)
				msgs = ((InternalEObject)newParentPlant).eInverseAdd(this, AsPackage.PLANT__STRUCTURES, Plant.class, msgs);
	...
	public EList<domain.as.ModuleRepository.Module> getModules() {
		if (modules == null) {
			modules = new EObjectContainmentEList<domain.as.ModuleRepository.Module>(domain.as.ModuleRepository.Module.class, this, StructureRepositoryPackage.STRUCTURE__MODULES);
		}
		return modules;
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case StructureRepositoryPackage.STRUCTURE__PARENT_PLANT:
				return eInternalContainer().eInverseRemove(this, AsPackage.PLANT__STRUCTURES, Plant.class, msgs);
		}
