...
import quality.as_foaa.Documentation;
...
import quality.as_foaa.Engineer;
import quality.as_foaa.FieldOfActivityAnnotationRepository;
import quality.as_foaa.File;
...
import quality.as_foaa.Mechanic;
 ...
 * @generated
 */
public class As_foaaPackageImpl extends EPackageImpl implements As_foaaPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see quality.as_foaa.As_foaaPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private As_foaaPackageImpl() {
		super(eNS_URI, As_foaaFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link As_foaaPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static As_foaaPackage init() {
		if (isInited) return (As_foaaPackage)EPackage.Registry.INSTANCE.getEPackage(As_foaaPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredAs_foaaPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		As_foaaPackageImpl theAs_foaaPackage = registeredAs_foaaPackage instanceof As_foaaPackageImpl ? (As_foaaPackageImpl)registeredAs_foaaPackage : new As_foaaPackageImpl();
		...
		theAs_foaaPackage.createPackageContents();

		// Initialize created meta-data
		theAs_foaaPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theAs_foaaPackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(As_foaaPackage.eNS_URI, theAs_foaaPackage);
		return theAs_foaaPackage;
	}
	 ...
	 * @generated
	 */
	public As_foaaFactory getAs_foaaFactory() {
		return (As_foaaFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getSystemTest_SystemUnderTest(), theAsPackage.getPlant(), null, "systemUnderTest", null, 0, 1, SystemTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
