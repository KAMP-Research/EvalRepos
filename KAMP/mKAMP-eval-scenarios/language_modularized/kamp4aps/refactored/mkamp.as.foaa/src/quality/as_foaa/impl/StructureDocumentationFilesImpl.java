 ...
 * </p>
 * <ul>
 *   <li>{@link quality.as_foaa.impl.StructureDocumentationFilesImpl#getMainteneance <em>Mainteneance</em>}</li>
 *   <li>{@link quality.as_foaa.impl.StructureDocumentationFilesImpl#getInstructions <em>Instructions</em>}</li>
 *   <li>{@link quality.as_foaa.impl.StructureDocumentationFilesImpl#getTrainingIntern <em>Training Intern</em>}</li>
 *   <li>{@link quality.as_foaa.impl.StructureDocumentationFilesImpl#getTrainingExternal <em>Training External</em>}</li>
 *   <li>{@link quality.as_foaa.impl.StructureDocumentationFilesImpl#getParent <em>Parent</em>}</li>
 *   <li>{@link quality.as_foaa.impl.StructureDocumentationFilesImpl#getDocumentedStructure <em>Documented Structure</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StructureDocumentationFilesImpl extends MinimalEObjectImpl.Container implements StructureDocumentationFiles {
	...
	protected EClass eStaticClass() {
		return As_foaaPackage.Literals.STRUCTURE_DOCUMENTATION_FILES;
	}
	...
	public EList<MainteneanceDocumentation> getMainteneance() {
		if (mainteneance == null) {
			mainteneance = new EObjectContainmentWithInverseEList<MainteneanceDocumentation>(MainteneanceDocumentation.class, this, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__MAINTENEANCE, As_foaaPackage.MAINTENEANCE_DOCUMENTATION__PARENT);
		}
		return mainteneance;
	}
	...
	public EList<OperatorInstructions> getInstructions() {
		if (instructions == null) {
			instructions = new EObjectContainmentWithInverseEList<OperatorInstructions>(OperatorInstructions.class, this, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__INSTRUCTIONS, As_foaaPackage.OPERATOR_INSTRUCTIONS__PARENT);
		}
		return instructions;
	}
	...
	public EList<TrainingDocIntern> getTrainingIntern() {
		if (trainingIntern == null) {
			trainingIntern = new EObjectContainmentWithInverseEList<TrainingDocIntern>(TrainingDocIntern.class, this, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__TRAINING_INTERN, As_foaaPackage.TRAINING_DOC_INTERN__PARENT);
		}
	...
	public EList<TrainingDocExternal> getTrainingExternal() {
		if (trainingExternal == null) {
			trainingExternal = new EObjectContainmentWithInverseEList<TrainingDocExternal>(TrainingDocExternal.class, this, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__TRAINING_EXTERNAL, As_foaaPackage.TRAINING_DOC_EXTERNAL__PARENT);
		}
	...
	public DocumentationSpecification getParent() {
		if (eContainerFeatureID() != As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT) return null;
	...
	public NotificationChain basicSetParent(DocumentationSpecification newParent, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newParent, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT, msgs);
		return msgs;
	}
	...
	public void setParent(DocumentationSpecification newParent) {
		if (newParent != eInternalContainer() || (eContainerFeatureID() != As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT && newParent != null)) {
			...
			if (newParent != null)
				msgs = ((InternalEObject)newParent).eInverseAdd(this, As_foaaPackage.DOCUMENTATION_SPECIFICATION__STRUCTURE_DOCUMENTATION, DocumentationSpecification.class, msgs);
			msgs = basicSetParent(newParent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT, newParent, newParent));
	}
		...
		if (documentedStructure != null && documentedStructure.eIsProxy()) {
			...
			if (documentedStructure != oldDocumentedStructure) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__DOCUMENTED_STRUCTURE, oldDocumentedStructure, documentedStructure));
			}
		}
	...
	public void setDocumentedStructure(Structure newDocumentedStructure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__DOCUMENTED_STRUCTURE, oldDocumentedStructure, documentedStructure));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT:
				return eInternalContainer().eInverseRemove(this, As_foaaPackage.DOCUMENTATION_SPECIFICATION__STRUCTURE_DOCUMENTATION, DocumentationSpecification.class, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__PARENT:
				return getParent();
			case As_foaaPackage.STRUCTURE_DOCUMENTATION_FILES__DOCUMENTED_STRUCTURE:
