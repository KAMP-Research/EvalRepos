 ...
 * @generated
 */
public class PpumodulesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PpumodulesPackage.POTENTIOMETER_MODULE: {
			...
			case PpumodulesPackage.INDUCTIVE_SENSOR_MODULE: {
			...
			case PpumodulesPackage.PRESSURE_SENSOR_MODULE: {
			...
			case PpumodulesPackage.PUSHER_MODULE: {
			...
			case PpumodulesPackage.RAMP_MODULE: {
			...
			case PpumodulesPackage.MICROSWITCH_MODULE: {
			...
			case PpumodulesPackage.MOTOR_MODULE: {
			...
			case PpumodulesPackage.MONOSTABLE_CYLINDER_MODULE: {
			...
			case PpumodulesPackage.VACUUM_GRIPPER_MODULE: {
			...
			case PpumodulesPackage.PRESENCE_SENSOR_MODULE: {
			...
			case PpumodulesPackage.OPTICAL_SENSOR_MODULE: {
			...
			case PpumodulesPackage.CONVEYOR_BELT_MODULE: {
			...
			case PpumodulesPackage.SENSOR_MODULE: {
