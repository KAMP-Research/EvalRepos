 ...
 * @generated
 */
public class PpubuscomponentsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PpubuscomponentsPackage.PROFIBUS_DP_SLAVE: {
			...
			case PpubuscomponentsPackage.ETHER_CAT_SLAVE: {
			...
			case PpubuscomponentsPackage.PROFIBUS_DP_CABLE: {
			...
			case PpubuscomponentsPackage.PROFIBUS_DP_BOX: {
			...
			case PpubuscomponentsPackage.PROFIBUS_DP_MASTER: {
			...
			case PpubuscomponentsPackage.ETHER_CAT_BOX: {
			...
			case PpubuscomponentsPackage.ETHER_CAT_MASTER: {
			...
			case PpubuscomponentsPackage.ETHER_CAT_CABLE: {
