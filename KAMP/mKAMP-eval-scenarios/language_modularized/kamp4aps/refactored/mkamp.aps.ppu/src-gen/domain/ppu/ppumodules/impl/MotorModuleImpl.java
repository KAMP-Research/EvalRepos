 ...
 * </p>
 * <ul>
 *   <li>{@link domain.ppu.ppumodules.impl.MotorModuleImpl#getSimpleMotor <em>Simple Motor</em>}</li>
 *   <li>{@link domain.ppu.ppumodules.impl.MotorModuleImpl#getBusSlave <em>Bus Slave</em>}</li>
 *   <li>{@link domain.ppu.ppumodules.impl.MotorModuleImpl#getBusBox <em>Bus Box</em>}</li>
 *   <li>{@link domain.ppu.ppumodules.impl.MotorModuleImpl#getBusCable <em>Bus Cable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MotorModuleImpl extends ModuleImpl implements MotorModule {
	...
	protected EClass eStaticClass() {
		return PpumodulesPackage.Literals.MOTOR_MODULE;
	}
	...
	public EList<SimpleMotor> getSimpleMotor() {
		if (simpleMotor == null) {
			simpleMotor = new EObjectContainmentEList<SimpleMotor>(SimpleMotor.class, this, PpumodulesPackage.MOTOR_MODULE__SIMPLE_MOTOR);
		}
		return simpleMotor;
	}
	...
	public EList<BusSlave> getBusSlave() {
		if (busSlave == null) {
			busSlave = new EObjectContainmentEList<BusSlave>(BusSlave.class, this, PpumodulesPackage.MOTOR_MODULE__BUS_SLAVE);
		}
		return busSlave;
	}
	...
	public NotificationChain basicSetBusBox(BusBox newBusBox, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PpumodulesPackage.MOTOR_MODULE__BUS_BOX, oldBusBox, newBusBox);
	...
	public void setBusBox(BusBox newBusBox) {
		if (newBusBox != busBox) {
			...
			if (busBox != null)
				msgs = ((InternalEObject)busBox).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PpumodulesPackage.MOTOR_MODULE__BUS_BOX, null, msgs);
			if (newBusBox != null)
				msgs = ((InternalEObject)newBusBox).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PpumodulesPackage.MOTOR_MODULE__BUS_BOX, null, msgs);
			msgs = basicSetBusBox(newBusBox, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PpumodulesPackage.MOTOR_MODULE__BUS_BOX, newBusBox, newBusBox));
	}
	...
	public EList<BusCable> getBusCable() {
		if (busCable == null) {
			busCable = new EObjectContainmentEList<BusCable>(BusCable.class, this, PpumodulesPackage.MOTOR_MODULE__BUS_CABLE);
		}
		return busCable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PpumodulesPackage.MOTOR_MODULE__SIMPLE_MOTOR:
				return ((InternalEList<?>)getSimpleMotor()).basicRemove(otherEnd, msgs);
			case PpumodulesPackage.MOTOR_MODULE__BUS_SLAVE:
				return ((InternalEList<?>)getBusSlave()).basicRemove(otherEnd, msgs);
			case PpumodulesPackage.MOTOR_MODULE__BUS_BOX:
				return basicSetBusBox(null, msgs);
			case PpumodulesPackage.MOTOR_MODULE__BUS_CABLE:
