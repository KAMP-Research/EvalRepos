 ...
 * </p>
 * <ul>
 *   <li>{@link domain.ppu.ppucomponents.impl.PowerSplitterImpl#getPowersupply <em>Powersupply</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PowerSplitterImpl extends SplitterImpl implements PowerSplitter {
	...
	protected EClass eStaticClass() {
		return PpucomponentsPackage.Literals.POWER_SPLITTER;
	}
		...
		if (powersupply != null && powersupply.eIsProxy()) {
			...
			if (powersupply != oldPowersupply) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PpucomponentsPackage.POWER_SPLITTER__POWERSUPPLY, oldPowersupply, powersupply));
			}
		}
		return powersupply;
	}
	...
	public void setPowersupply(PowerSupply newPowersupply) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PpucomponentsPackage.POWER_SPLITTER__POWERSUPPLY, oldPowersupply, powersupply));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PpucomponentsPackage.POWER_SPLITTER__POWERSUPPLY:
