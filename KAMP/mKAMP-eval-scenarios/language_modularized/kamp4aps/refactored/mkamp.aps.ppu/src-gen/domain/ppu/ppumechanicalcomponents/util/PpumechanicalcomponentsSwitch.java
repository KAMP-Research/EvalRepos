 ...
 * @generated
 */
public class PpumechanicalcomponentsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public PpumechanicalcomponentsSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PpumechanicalcomponentsPackage.ARM: {
			...
			case PpumechanicalcomponentsPackage.HOUSING: {
