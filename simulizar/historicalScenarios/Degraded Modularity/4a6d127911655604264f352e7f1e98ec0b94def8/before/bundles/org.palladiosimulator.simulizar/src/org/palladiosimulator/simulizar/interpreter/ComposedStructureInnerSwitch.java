...
import extension.infrastructure.composition.AssemblyInfrastructureConnector;
import composition.Connector;
import softwarecomposition.RequiredDelegationConnector;
import extension.infrastructure.composition.RequiredInfrastructureDelegationConnector;
...
class ComposedStructureInnerSwitch extends CompositionSwitch<SimulatedStackframe<Object>> {
     ...
     * (non-Javadoc)
     *
     * @see composition.util.CompositionSwitch#
     * caseAssemblyInfrastructureConnector
     * (extension.infrastructure.composition.AssemblyInfrastructureConnector)
     */
    @Override
