...
import extensions.resourceinterfaces.resourcetype.ResourceProvidedRole;
import repository.Parameter;
import environment.resources.ResourceContainer;
import extensions.resourceinterfaces.resourcetype.ResourceInterface;
import environment.resources.resourcetype.ResourceRepository;
import extensions.resourceinterfaces.resourcetype.ResourceSignature;
import environment.resources.resourcetype.ResourceType;
import behaviour.seff.AbstractAction;
import behaviour.seff.AbstractBranchTransition;
import behaviourseff.AcquireAction;
import behaviour.seff.BranchAction;
import behaviourseff.CollectionIteratorAction;
import behaviourseff.ExternalCallAction;
import behaviour.seff.ForkAction;
import behaviour.seff.ForkedBehaviour;
import behaviour.seff.InternalAction;
import behaviour.seff.LoopAction;
import behaviourseff.ReleaseAction;
import org.palladiosimulator.pcm.seff.ResourceDemandingBehaviour;
import behaviour.seff.SeffPackage;
import behaviourseff.SetVariableAction;
import extensions.infrastructure.seff.InfrastructureCall;
import performance.seff.ParametricResourceDemand;
import extensions.resourceinterfaces.seff.ResourceCall;
import seff.util.SeffSwitch;
...
class RDSeffSwitch extends SeffSwitch<Object> implements IComposableSwitch {
    ...
    /**
     * @see seff.util.SeffSwitch#caseResourceDemandingBehaviour(org.palladiosimulator.pcm.seff.ResourceDemandingBehaviour)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseAbstractAction(behaviour.seff.AbstractAction)
     */
    /*
     * (non-Javadoc)
     *
     * @see
     * seff.util.SeffSwitch#caseAbstractAction(org.palladiosimulator.pcm.
     * seff.AbstractAction )
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseInternalAction(behaviour.seff.InternalAction)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseExternalCallAction(behaviourseff.ExternalCallAction)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseBranchAction(behaviour.seff.BranchAction)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseCollectionIteratorAction(behaviourseff.CollectionIteratorAction)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseForkAction(behaviour.seff.ForkAction)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseLoopAction(behaviour.seff.LoopAction)
     */
    @Override
    ...
    /**
     * @see seff.util.SeffSwitch#caseSetVariableAction(behaviourseff.SetVariableAction)
     */
    @Override
     ...
     *
     * @see
     * seff.util.SeffSwitch#caseAcquireAction(org.palladiosimulator.pcm.
     * seff.AcquireAction )
     */
    @Override
     ...
     *
     * @see
     * seff.util.SeffSwitch#caseReleaseAction(org.palladiosimulator.pcm.
     * seff.ReleaseAction )
     */
    @Override
