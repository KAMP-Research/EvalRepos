...
public class SimulatedBasicComponentInstance extends SimulatedComponentInstance {
    ...
    public void acquirePassiveResource(final PassiveResource passiveResource,
            final InterpreterDefaultContext context, double timeoutValue) {
        this.checkAcquireReleasePrecondition(passiveResource);

        this.passiveResourcesMap.get(passiveResource.getId()).acquire(context.getThread(), 1, true,
                timeoutValue);
    }
    ...
    public void acquirePassiveResource(final PassiveResource passiveResource,
        ...
        this.passiveResourcesMap.get(passiveResource.getId()).acquire(context.getThread(), 1, false,
                0);
    }
