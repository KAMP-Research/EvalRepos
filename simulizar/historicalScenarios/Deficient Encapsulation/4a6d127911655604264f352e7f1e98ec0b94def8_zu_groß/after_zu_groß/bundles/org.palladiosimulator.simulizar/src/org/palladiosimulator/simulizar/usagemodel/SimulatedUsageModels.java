...
public class SimulatedUsageModels {
    ...
    public IWorkloadDriver createAndAddWorkloadDriver(final UsageScenario usageScenario) {
        ...
        if (workload.eClass() == UsagemodelPackage.eINSTANCE.getClosedWorkload()) {
            final de.uka.ipd.sdq.simucomframework.usage.ClosedWorkload driver = this.createClosedWorkloadDriver(new WorkloadUseageScenario(workload,
                    usageScenario));
            ...
            final de.uka.ipd.sdq.simucomframework.usage.OpenWorkload driver = this.createOpenWorkloadDriver(
    ...
    private de.uka.ipd.sdq.simucomframework.usage.ClosedWorkload createClosedWorkloadDriver(WorkloadUseageScenario wlu) {
        ...
        final IClosedWorkloadUserFactory userFactory = new ClosedWorkloadUserFactory(this.rootContext.getModel(),
                closedWorkload.getThinkTime_ClosedWorkload().getSpecification(), wlu.getUsageScenario()) {
    ...
    private de.uka.ipd.sdq.simucomframework.usage.OpenWorkload createOpenWorkloadDriver(
        ...
        final IUserFactory userFactory = new OpenWorkloadUserFactory(this.rootContext.getModel(), wlu.getUsageScenario()) {
