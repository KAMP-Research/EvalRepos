...
public class ViralHacker implements IAttackerSimulation {
    ...
    public ScenarioResult run(SmartGridTopologyScenarioResult result) {
        SmartGridTopology topo = result.getTopo();
        ScenarioResult scenario = result.getScenario();
        if (!this.initDone) {
     ...
     */
    private void standardHacking(SmartGridTopologyScenarioResult result) {
        SmartGridTopology topo = result.getTopo();
        ScenarioResult impactAnalysisOutput = result.getScenario();
