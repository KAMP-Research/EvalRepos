...
public class LoadInputModelConformityHelper {
    ...
    public static boolean checkInputModelConformitySimple(SmartGridTopologyScenarioResult result) {
        SmartGridTopology current = result.getTopo();
        ScenarioResult state = result.getResult();
    ...
    public static boolean checkInputModelConformity(SmartGridTopologyScenarioResult result) {

        final boolean simpleConform = checkInputModelConformitySimple(result);
...
//            return powerStatesConform && entityStatesConform;
    ...
    private static boolean updated(SmartGridTopologyScenarioResult result) {
        SmartGridTopology topology = result.getTopo();
        ScenarioResult scenarioState = result.getResult();
