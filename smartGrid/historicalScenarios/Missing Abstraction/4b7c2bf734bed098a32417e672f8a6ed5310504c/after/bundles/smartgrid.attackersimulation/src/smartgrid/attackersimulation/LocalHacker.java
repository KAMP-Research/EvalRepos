...
public class LocalHacker implements IAttackerSimulation {
    ...
    @Deprecated
    public void initForTest(HackingType hackingStyle, HackingSpeed hackingSpeed, String rootNode) {

        this.hackingSpeed = hackingSpeed.getHackingSpeed();
        this.ignoreLogicalConnections = false;
        final var hackingType = hackingStyle;
        switch (hackingType) {
        case BFS_HACKING:
