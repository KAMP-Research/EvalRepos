...
public class RmiServer implements ISimulationControllerRemote {
	...
	@Deprecated
	public void initReactive(Path outputPath, Path topoPath, Path inputStatePath)
		...
		initMap.put(InitializationMapKeys.INPUT_PATH_KEY, inputStatePath.toString());
		initMap.put(InitializationMapKeys.OUTPUT_PATH_KEY, outputPath.toString());
		initMap.put(InitializationMapKeys.TOPO_PATH_KEY, topoPath.toString());
