 ...
 * @generated
 */
public class TyperepoSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TyperepoPackage.REPOSITORY: {
			...
			case TyperepoPackage.SMART_METER_TYPE: {
			...
			case TyperepoPackage.CONNECTION_TYPE: {
			...
			case TyperepoPackage.NETWORK_NODE_TYPE: {
