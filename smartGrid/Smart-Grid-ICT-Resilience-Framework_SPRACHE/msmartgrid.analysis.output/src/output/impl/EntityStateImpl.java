 ...
 * </p>
 * <ul>
 *   <li>{@link output.impl.EntityStateImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EntityStateImpl extends MinimalEObjectImpl.Container implements EntityState {
	...
	protected EClass eStaticClass() {
		return OutputPackage.Literals.ENTITY_STATE;
	}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OutputPackage.ENTITY_STATE__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public void setOwner(NetworkEntity newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OutputPackage.ENTITY_STATE__OWNER, oldOwner, owner));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OutputPackage.ENTITY_STATE__OWNER:
