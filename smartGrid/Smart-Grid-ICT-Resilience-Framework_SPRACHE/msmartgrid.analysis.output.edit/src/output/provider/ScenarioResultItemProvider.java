...
/**
 * This is the item provider adapter for a {@link output.ScenarioResult} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScenarioResultItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 OutputPackage.Literals.SCENARIO_RESULT__SCENARIO,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OutputPackage.Literals.SCENARIO_RESULT__STATES);
			childrenFeatures.add(OutputPackage.Literals.SCENARIO_RESULT__CLUSTERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.SCENARIO_RESULT__STATES,
				 OutputFactory.eINSTANCE.createOnline()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.SCENARIO_RESULT__STATES,
				 OutputFactory.eINSTANCE.createDefect()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.SCENARIO_RESULT__STATES,
				 OutputFactory.eINSTANCE.createNoPower()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.SCENARIO_RESULT__STATES,
				 OutputFactory.eINSTANCE.createNoUplink()));

		newChildDescriptors.add
			(createChildParameter
				(OutputPackage.Literals.SCENARIO_RESULT__CLUSTERS,
				 OutputFactory.eINSTANCE.createCluster()));
	}
