...
/**
 * This is the item provider adapter for a {@link graph.NetworkEntity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphPackage.Literals.NETWORK_ENTITY__CONNECTED_TO,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GraphPackage.Literals.NETWORK_ENTITY__LINKED_BY,
				 true,
				 false,
				 true,
				 null,
