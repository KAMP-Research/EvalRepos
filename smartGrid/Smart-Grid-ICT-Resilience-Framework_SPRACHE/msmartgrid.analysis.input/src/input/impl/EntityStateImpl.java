 ...
 * </p>
 * <ul>
 *   <li>{@link input.impl.EntityStateImpl#isIsDestroyed <em>Is Destroyed</em>}</li>
 *   <li>{@link input.impl.EntityStateImpl#isIsHacked <em>Is Hacked</em>}</li>
 *   <li>{@link input.impl.EntityStateImpl#getOwner <em>Owner</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EntityStateImpl extends MinimalEObjectImpl.Container implements EntityState {
	...
	protected EClass eStaticClass() {
		return InputPackage.Literals.ENTITY_STATE;
	}
	...
	public void setIsDestroyed(boolean newIsDestroyed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.ENTITY_STATE__IS_DESTROYED, oldIsDestroyed, isDestroyed));
	}
	...
	public void setIsHacked(boolean newIsHacked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.ENTITY_STATE__IS_HACKED, oldIsHacked, isHacked));
	}
	...
	public NetworkEntity getOwner() {
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InputPackage.ENTITY_STATE__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public void setOwner(NetworkEntity newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.ENTITY_STATE__OWNER, oldOwner, owner));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InputPackage.ENTITY_STATE__IS_DESTROYED:
				return isIsDestroyed();
			case InputPackage.ENTITY_STATE__IS_HACKED:
				return isIsHacked();
			case InputPackage.ENTITY_STATE__OWNER:
