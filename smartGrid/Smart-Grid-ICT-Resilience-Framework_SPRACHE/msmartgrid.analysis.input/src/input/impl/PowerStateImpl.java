 ...
 * </p>
 * <ul>
 *   <li>{@link input.impl.PowerStateImpl#getOwner <em>Owner</em>}</li>
 *   <li>{@link input.impl.PowerStateImpl#isPowerOutage <em>Power Outage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PowerStateImpl extends MinimalEObjectImpl.Container implements PowerState {
	...
	protected EClass eStaticClass() {
		return InputPackage.Literals.POWER_STATE;
	}
		...
		if (owner != null && owner.eIsProxy()) {
			...
			if (owner != oldOwner) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InputPackage.POWER_STATE__OWNER, oldOwner, owner));
			}
		}
		return owner;
	}
	...
	public void setOwner(PowerGridNode newOwner) {
		...
		owner = newOwner;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.POWER_STATE__OWNER, oldOwner, owner));
	}
	...
	public void setPowerOutage(boolean newPowerOutage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.POWER_STATE__POWER_OUTAGE, oldPowerOutage, powerOutage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InputPackage.POWER_STATE__OWNER:
				if (resolve) return getOwner();
				return basicGetOwner();
			case InputPackage.POWER_STATE__POWER_OUTAGE:
