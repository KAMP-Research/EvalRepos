 ...
 * </p>
 * <ul>
 *   <li>{@link input.impl.ScenarioStateImpl#getEntityStates <em>Entity States</em>}</li>
 *   <li>{@link input.impl.ScenarioStateImpl#getPowerStates <em>Power States</em>}</li>
 *   <li>{@link input.impl.ScenarioStateImpl#getScenario <em>Scenario</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScenarioStateImpl extends MinimalEObjectImpl.Container implements ScenarioState {
	...
	protected EClass eStaticClass() {
		return InputPackage.Literals.SCENARIO_STATE;
	}
	...
	public EList<EntityState> getEntityStates() {
		if (entityStates == null) {
			entityStates = new EObjectContainmentEList<EntityState>(EntityState.class, this, InputPackage.SCENARIO_STATE__ENTITY_STATES);
		}
		return entityStates;
	}
	...
	public EList<PowerState> getPowerStates() {
		if (powerStates == null) {
			powerStates = new EObjectContainmentEList<PowerState>(PowerState.class, this, InputPackage.SCENARIO_STATE__POWER_STATES);
		}
		return powerStates;
	}
		...
		if (scenario != null && scenario.eIsProxy()) {
			...
			if (scenario != oldScenario) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InputPackage.SCENARIO_STATE__SCENARIO, oldScenario, scenario));
			}
		}
		return scenario;
	}
	...
	public void setScenario(SmartGridTopology newScenario) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InputPackage.SCENARIO_STATE__SCENARIO, oldScenario, scenario));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InputPackage.SCENARIO_STATE__ENTITY_STATES:
				return ((InternalEList<?>)getEntityStates()).basicRemove(otherEnd, msgs);
			case InputPackage.SCENARIO_STATE__POWER_STATES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case InputPackage.SCENARIO_STATE__SCENARIO:
