...
public interface ExternalTaskService {
   ...
   */
  public ExternalTaskQueryBuilder fetchAndLock(int maxTasks, Id workerId);
   ...
   * @return a builder to define and execute an external task fetching operation
   */
  public ExternalTaskQueryBuilder fetchAndLock(int maxTasks, Id workerId, boolean usePriority);
   ...
   *   </ul>
   */
  public void lock(Id externalTaskId, Id workerId, long lockDuration);
   ...
   *   </ul>
   */
  public void complete(Id externalTaskId, Id workerId);
   ...
   *   </ul>
   */
  public void complete(Id externalTaskId, Id workerId, Map<String, Object> variables);
   ...
   *   </ul>
   */
  public void complete(Id externalTaskId, Id workerId, Map<String, Object> variables, Map<String, Object> localVariables);
   ...
   *   </ul>
   */
  public void extendLock(Id externalTaskId, Id workerId, long newLockDuration);
   ...
   *   </ul>
   */
  public void handleFailure(Id externalTaskId, Id workerId, String errorMessage, int retries, long retryTimeout);
   ...
   *   </ul>
   */
  public void handleFailure(Id externalTaskId, Id workerId, String errorMessage, String errorDetails, int retries, long retryTimeout);
   ...
   *   </ul>
   */
  public void handleFailure(Id externalTaskId, Id workerId, String errorMessage, String errorDetails, int retries, long retryDuration, Map<String, Object> variables, Map<String, Object> localVariables);
   ...
   *   </ul>
   */
  public void handleBpmnError(Id externalTaskId, Id workerId, String errorCode);
   ...
   *   </ul>
   */
  public void handleBpmnError(Id externalTaskId, Id workerId, String errorCode, String errorMessage);
   ...
   *   </ul>
   */
  public void handleBpmnError(Id externalTaskId, Id workerId, String errorCode, String errorMessage, Map<String, Object> variables);
   ...
   *   </ul>
   */
  public void unlock(Id externalTaskId);
   ...
   *   </ul>
   */
  public void setRetries(Id externalTaskId, int retries);
   ...
   *   </ul>
   */
  public void setPriority(Id externalTaskId, long priority);
   ...
   * @since 7.6
   */
  String getExternalTaskErrorDetails(Id externalTaskId);
}