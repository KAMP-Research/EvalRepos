...
public class DbSqlSessionFactory implements SessionFactory {
  ...
  protected static void addDatabaseSpecificStatement(DataBaseTypes databaseType, Statement activitiStatement, 
      Statement ibatisStatement) {
    Map<String, String> specificStatements = databaseSpecificStatements.get(databaseType.toString());
