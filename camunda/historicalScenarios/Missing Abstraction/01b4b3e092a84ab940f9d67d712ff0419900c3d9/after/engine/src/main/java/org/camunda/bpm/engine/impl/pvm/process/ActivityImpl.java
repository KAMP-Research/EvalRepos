...
public class ActivityImpl extends ScopeImpl implements PvmActivity, HasDIBounds {
  ...
  public void toggleAsyncBefore() {
    setAsyncBeforeExclusive(!isAsyncBefore());
  }

  public void setAsyncBeforeExclusive(boolean isAsyncBefore) {
    if (delegateAsyncBeforeUpdate != null)
      delegateAsyncBeforeUpdate.updateAsyncBefore(isAsyncBefore, true);
    this.isAsyncBefore = isAsyncBefore;
  }
  public void setAsyncBefore(boolean isAsyncBefore) {
    if (delegateAsyncBeforeUpdate != null)
      delegateAsyncBeforeUpdate.updateAsyncBefore(isAsyncBefore, false);
    this.isAsyncBefore = isAsyncBefore;
  }
  ...
  public void toggleAsyncAfter() {
    setAsyncAfter(!isAsyncAfter(), true);
  }

  public void setAsyncAfterExclusive(boolean isAsyncAfter) {
    if (delegateAsyncAfterUpdate != null)
      delegateAsyncAfterUpdate.updateAsyncAfter(isAsyncAfter, true);
    this.isAsyncAfter = isAsyncAfter;
  }
  public void setAsyncAfter(boolean isAsyncAfter) {
    if (delegateAsyncAfterUpdate != null)
      delegateAsyncAfterUpdate.updateAsyncAfter(isAsyncAfter, false);
    this.isAsyncAfter = isAsyncAfter;
  }
