...
public class ManagementServiceImpl extends ServiceImpl implements ManagementService {
  ...
  public void unregisterProcessApplication(Id deploymentId, boolean removeProcessesFromCache) {
    commandExecutor.execute(new UnregisterProcessApplicationCmd(deploymentId.getId(), removeProcessesFromCache));
  }

  public void unregisterProcessApplication(Set<Id> deploymentIds, boolean removeProcessesFromCache) {
    commandExecutor.execute(new UnregisterProcessApplicationCmd(deploymentIds.stream().map(v -> v.getId()).collect(Collectors.toList()), removeProcessesFromCache));
  }

  public String getProcessApplicationForDeployment(Id deploymentId) {
    return commandExecutor.execute(new GetProcessApplicationForDeploymentCmd(deploymentId.getId()));
  }
  ...
  public void executeJob(Id jobId) {
    ExecuteJobHelper.executeJob(jobId, commandExecutor);
  }

  public void deleteJob(Id jobId) {
    commandExecutor.execute(new DeleteJobCmd(jobId));
  }

  public void setJobRetries(Id jobId, int retries) {
  ...
  public void setJobDuedate(Id jobId, Date newDuedate) {
    setJobDuedate(jobId, newDuedate, false);
  }

  public void setJobDuedate(Id jobId, Date newDuedate, boolean cascade) {
    commandExecutor.execute(new SetJobDuedateCmd(jobId, newDuedate, cascade));
  }

  public void recalculateJobDuedate(Id jobId, boolean creationDateBased) {
    commandExecutor.execute(new RecalculateJobDuedateCmd(jobId, creationDateBased));
  }

  public void setJobPriority(Id jobId, long priority) {
  ...
  public String getJobExceptionStacktrace(Id jobId) {
  ...
  public void activateJobById(Id jobId) {
  ...
  public void suspendJobById(Id jobId) {
    updateJobSuspensionState()
        .byJobId(jobId)
        .suspend();
  }
